...
if ( ! class_exists( 'YITH_WCAF_Commission_Handler' ) ) {
	...
	class YITH_WCAF_Commission_Handler {
		...
		public function __construct() {
			...
			add_filter( 'manage_yit-plugins_page_yith_wcaf_panel_columns', array( $this, 'add_screen_columns' ) );
			add_filter( 'set-screen-option', array( $this, 'set_screen_option' ), 10, 3 );
			add_action( 'load-yit-plugins_page_yith_wcaf_panel', array( $this, 'process_bulk_actions' ) );
		...
		public function get_readable_status( $status ){
			return apply_filters( "yith_wcaf_{$status}_commission_status_name", ucfirst( str_replace( '-', ' ', $status ) ) );
		}
		...
		public function get_available_status() {
			return $this->_available_commission_status;
		}
		...
		public function add_screen_option() {
			if ( 'yit-plugins_page_yith_wcaf_panel' == get_current_screen()->id && ( ! isset( $_GET['tab'] ) || ( isset( $_GET['tab'] ) && $_GET['tab'] == 'commissions' ) ) ) {
