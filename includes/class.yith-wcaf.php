...
if ( ! class_exists( 'YITH_WCAF' ) ) {
	...
	class YITH_WCAF {
		...
		public function enqueue() {
			...
			wp_register_style( 'jquery-ui', YITH_WCAF_URL . 'assets/css/jquery-ui.min.css' );
		...
		public function plugin_fw_loader() {
			if ( ! defined( 'YIT' ) || ! defined( 'YIT_CORE_PLUGIN' ) ) {
				require_once( YITH_WCAF_DIR . '/plugin-fw/yit-plugin.php' );
			}
		}
